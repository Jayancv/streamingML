...
public class AppTestCase {
    ...
    public void testClassificationStreamProcessorExtension() throws InterruptedException {
        ...
        String query = ("@info(name = 'query1') from inputStream#streamingml:streamingClassificationSamoa(1000000,5000,3,5,0,\"\",1,0, attribute_0, attribute_1 , attribute_2 , attribute_3 , attribute_4) " +
...
//            Assert.assertTrue(eventArrived);
    ...
    public void testRegressionStreamProcessorExtension() throws InterruptedException {
        ...
        String query = ("@info(name = 'query2') from inputStream#streamingml:streamingRegressionSamoa(1000000,5000,5,4,0, attribute_0, attribute_1 , attribute_2 , attribute_3 , attribute_4) " +
                "select att_0 as arrtibute_0,att_1 as arrtibute_1,att_2 as arrtibute_2,att_3 as arrtibute_3, prediction as prediction insert into outputStream;");
        ExecutionPlanRuntime executionPlanRuntime = siddhiManager.createExecutionPlanRuntime(inStreamDefinition + query);
...
//            Assert.assertTrue(eventArrived);
    ...
    public void testClusteringStreamProcessorExtension() throws InterruptedException {
        ...
        String inStreamDefinition = " define stream inputStream (attribute_0 double, attribute_1 double, attribute_2 double, attribute_3 double, attribute_4 double );";
        String query = ("@info(name = 'query3') from inputStream#streamingml:streamingClusteringSamoa(10000,10,2,1,0.95, attribute_0, attribute_1 , attribute_2 , attribute_3 , attribute_4) " +
