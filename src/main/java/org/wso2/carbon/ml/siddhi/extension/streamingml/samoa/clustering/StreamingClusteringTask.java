...
public class StreamingClusteringTask implements Task, Configurable {
    ...
    public IntOption instanceLimitOption = new IntOption("instanceLimit", 'i',
            "Maximum number of instances to test/train on  (-1 = no limit).", 100000, -1, Integer.MAX_VALUE);
    ...
    public StringOption evaluationNameOption = new StringOption("evaluationName", 'n',
            "Identifier of the evaluation", "Clustering__" + new SimpleDateFormat("yyyyMMddHHmmss").format(new Date()));
    ...
    public void init() {
        ...
        StreamingClusteringEvaluationProcessor resultCheckPoint = new StreamingClusteringEvaluationProcessor("Result" +
                " Check Point ");
